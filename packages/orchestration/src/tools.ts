...
function renderPlan(facade: SophiaTeamFacade, plan: { members: Array<{ name: string; role?: string }>; tasks: Array<{ id: string; subject: string; assignee?: string; dependencies?: string[] }> }): string {
