...
export const ACTIVITY_STATE_URL = '/plugins/dsh-sophia-entities/state';
export const ACTIVITY_HALT_URL = '/plugins/dsh-sophia-entities/halt';
/**
...
export function startActivityPolling(monitorTargets, runtime = {}) {
    ...
    const tick = async () => {
        ...
        try {
            ...
            if (cancelled)
                return;
            if (!Array.isArray(archivedBody.teams))
