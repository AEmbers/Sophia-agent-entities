...
export declare const AGENT_TEAMS_LOCALE_NAMESPACE = "sophiaEntities";
/** Simplified Chinese dictionary (the key-set source of truth). */
export declare const zh: {
    'workspace.dependencies': string;
    'workspace.title': string;
    'workspace.guide': string;
    'workspace.eyebrow': string;
    'workspace.description': string;
    'workspace.relationships': string;
    'workspace.emptyTitle': string;
    'workspace.emptyBody': string;
    'workspace.loading': string;
    'workspace.error': string;
    'workspace.retry': string;
    'workspace.current': string;
    'workspace.history': string;
    'workspace.back': string;
    'workspace.tasks': string;
    'workspace.members': string;
    'workspace.completed': string;
    'workspace.focus': string;
    'workspace.noTasks': string;
    ...
    'task.model': string;
    'task.detail.cancelled': string;
    'task.detail.failed': string;
    ...
    'approval.state.pending_owner': string;
    'approval.state.pending_captain': string;
    'approval.goalLabel': string;
    'approval.requesterLabel': string;
    'approval.requester.human': string;
    'approval.requester.member': string;
    'approval.modeLabel': string;
    'approval.mode.persistent': string;
    'approval.mode.persistent.desc': string;
    ...
    'approval.review.downgradeReason': string;
